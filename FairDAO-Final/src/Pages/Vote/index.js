                                    ...
                                    >
                                        ...
                                        <TableCell align="center">
                                            <Stack 
                                                ...
                                                sx={{ width: 60, height: 60, borderRadius: 2, border: `1px solid ${this.props.theme.palette.divider}` }}>
                                                <Box src={element.source ? element.source : "/images/election.png"} component="img" sx={{ width: 40 }} />
                                            </Stack>
                                        </TableCell>
                                        ...
                                        <TableCell align="center">
                                            <Stack flexDirection="row" alignItems="center" justifyContent="center" gap={1}>
                                                ...
                                                >No</Button>
                                                { (this.props.account === this.state.admin || this.props.account === this.state.owner) 
                                                    ?
                                                        <Button
                                                            variant="outlined" 
                                                            color="primary" 
                                                            size="small"
                                                            disabled={(this.props.position === 'GUEST' || this.props.position === 'MEMBER') ? true :  false}
