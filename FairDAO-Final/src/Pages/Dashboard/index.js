...
const cards = [
    ...
    { img: '/images/holder.png', color: '#ECFBFF', img_dark: '/images/holder_dark.png', title: 'Holder Number', price: 230 },
    { img: '/images/owner.png', color: '#EDFFEF', img_dark: '/images/owner_dark.png', title: 'Dao Owner', price: '0x176B6eB693792Ad7081E2 5B537D8E14bea130Ff8' },
]
    ...
    async init (nextProps) {
        if (nextProps.account) {
            ...
            this.setState({
                ...
                realHolderTable: holderContainer.slice((this.state.page - 1) * pageStep, this.state.page * pageStep),
                loading: false
            })
        }
    }
        ...
        return (
            <Box sx={{ pb: 7 }}>
                ...
                >
                    ...
                    >
                        <Typography variant="h3">Fair Governance Token</Typography>
                        <Stack 
                        ...
                        {cards.map ((element, key) => 
                            ...
                            >
                                ...
                                <Typography variant={ key === 2 ? "subtitle2" : "h1"} sx={{ textAlign: 'center', wordBreak: 'break-all' }}>
                                {key === 0 
                ...
                <Box sx={{
                    ...
                    <Typography variant="h3">Members of Fair DAO</Typography>
                    <Box sx={{
                        pt: 3,
