                ...
                >
                    <Toolbar sx={{ gap: this.props.matchUpMd ? 6 : 2, justifyContent: 'space-between' }}>
                        <Stack alignItems="center" flexDirection="row" gap={this.props.matchUpMd ? 6 : 2}>
                            ...
                            <Link to="/">
                                <Box 
                                    sx={{ display: { xs: 'none', sm: 'block' }, width: '50px', borderRadius: '999px' }}
                                    component="img" 
                                    ...
                                    <Stack>
                                        ...
                                        ?
                                            <Tooltip title={this.state.account}>
                                                ...
                                                >{this.state.account ? (this.state.account.slice(0,8) + "...") : ""}</Typography>
                                            </Tooltip>
                                        :
                                            <></>
                                        }
                                        ...
                                        >{this.state.position}</Typography>
                                    </Stack>
                                </Stack>
