        ...
        return (
            ...
            >
                <Stack flexDirection="row" alignItems="center" justifyContent='space-between'>
                    <Typography variant="caption" sx={{ color: this.props.theme.palette.text.disabled }}>@ 2022 Fair</Typography>
                    <Link href="https://www.iamfuture.life/" target="_blank" sx={{ textDecoration: 'none', display: 'flex' }}>
                        <Typography 
                            variant="caption" 
                            sx={{ 
                                color: this.props.theme.palette.text.disabled 
                            }}
                        >I Am Future.</Typography>
                    </Link>
                    <Link href="https://www.mayabernaia.com/" target="_blank" sx={{ textDecoration: 'none', display: 'flex' }}>
                        <Typography 
                            variant="caption" 
                            sx={{ 
                                color: this.props.theme.palette.text.disabled 
                            }}
                        >www.mayabernaia.com</Typography>
                    </Link>
                </Stack>
            </Box>
        );
