...
const Menu = (props) => {
    ...
    return (
        <div>
            ...
            {/* <Divider /> */}
            <List>
                <ListItem sx={{ p: .5, display: { sm: 'none', xs: 'flex', } }}>
                    <Stack flexDirection="row" alignItems="center" gap={1} sx={{
                        display: { xs: 'flex' }}}>
                        <Avatar sx={{ width: 36, height:  36, bgcolor: theme.palette.text.primary }} />
                        <Stack>
                            {account 
                            ?
                                <Tooltip title={account}>
                                    ...
                                    >{account ? (account.slice(0,8) + "...") : ""}</Typography>
                                </Tooltip>
                            :
                                <></>
                            }
                ...
                <ListItem sx={{ p: .5, pb: 2, display: { sm: 'none', xs: 'flex', } }}>
                    <Button 
                        variant="outlined" 
                        color="success" 
                        fullWidth
                    ...
                    >
                        ...
                        <Typography variant="body1">Connect Wallet</Typography></Button>
                </ListItem>
