...
import { RPC, vrtAddress, vrtABI, daoABI, daoAddress } from '../Constants/config';
...
export const Web3Provider = ({ children }) => {
    ...
    return <Web3Context.Provider value={{ ...data, walletConnect }}>{ children }</Web3Context.Provider>
}
